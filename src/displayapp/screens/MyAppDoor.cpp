...
static void event_handler(lv_obj_t* obj, lv_event_t event) {
  MyAppDoor* screen = static_cast<MyAppDoor*>(obj->user_data);
  screen->OnObjectEvent(obj, event);
}

MyAppDoor::MyAppDoor(Pinetime::Controllers::RemoteControlService& remoteControl) 
...
void MyAppDoor::OnObjectEvent(lv_obj_t* obj, lv_event_t event) {
