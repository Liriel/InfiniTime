#include "displayapp/screens/SofaControl.h"
#include <cstdint>
...
static void event_handler(lv_obj_t* obj, lv_event_t event) {
  SofaControl* screen = static_cast<SofaControl*>(obj->user_data);
  screen->OnObjectEvent(obj, event);
}

SofaControl::SofaControl(Pinetime::Controllers::RemoteControlService& remoteControl) 
...
SofaControl::~SofaControl() {
  lv_obj_clean(lv_scr_act());
}

void SofaControl::OnObjectEvent(lv_obj_t* obj, lv_event_t event) {
