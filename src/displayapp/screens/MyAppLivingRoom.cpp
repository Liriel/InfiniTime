...
static void event_handler(lv_obj_t* obj, lv_event_t event) {
  MyAppLivingRoom* screen = static_cast<MyAppLivingRoom*>(obj->user_data);
  screen->OnObjectEvent(obj, event);
}

MyAppLivingRoom::MyAppLivingRoom(Pinetime::Controllers::RemoteControlService& remoteControl) 
...
MyAppLivingRoom::~MyAppLivingRoom() {
  lv_obj_clean(lv_scr_act());
}

void MyAppLivingRoom::OnObjectEvent(lv_obj_t* obj, lv_event_t event) {
